...
const Reservations = ({ reservations }) => {
    ...
    return (
        <div className="grid items-center justify-center gap-4 mx-auto mt-12 lg:grid-cols-2 md:gap-6">
                ...
                return (
                    <div key={reservation.id} className="flex flex-col w-full bg-white rounded shadow-lg dark:bg-transparent">
                        <div className="flex flex-col w-full md:flex-row ">
                            <div className="flex flex-row justify-around p-4 font-bold leading-none text-gray-800 uppercase bg-gray-400 rounded dark:rounded-r-none md:flex-col md:items-center md:justify-center md:w-1/4">
                            ...
                            <div className="p-4 font-normal dark:text-white text-gray-800 md:w-3/4 dark:border border-[#ccc] dark:rounded dark:rounded-l-none">
                                <h1 className="mb-4 text-4xl font-bold leading-none tracking-tight text-gray-800 dark:text-white"><b>Reservation for: </b>{reservation.name}</h1>
                                ...
                                <p className='mt-4 leading-normal'><b>Note: </b>{reservation.note}</p>
                            </div>
                        </div>
                    </div>
                )

...
const CartSuggestions = () => {
  ...
  return (
    <div className="flex flex-col items-start justify-between overflow-hidden">
      <h2 className="my-2 text-xl font-bold text-gray-700">Suggestions</h2>
      <div className="grid w-full gap-2 overflow-hidden justify-content-between md:grid-cols-2">
          ...
          return (
            <div key={item.id} className="flex bg-gray-200 rounded-md">
              <img
                src={item.image}
                alt={item.title}
                className="object-cover w-24 h-24 border border-gray-200 rounded-md rounded-r-none"
              />
